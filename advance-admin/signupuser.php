...
$query="insert into student(regnum,name,password,email,contact) values('$regnum','$name','$password','$email','$contact')"or die(mysql_error());
$rs=mysql_query($query)or die("Could Not Perform the Query".mysql_error());
echo "<br><br><br><H1>Your Login ID(user name) :  $regnum Created Sucessfully</H1>";
echo "<br><H2>Please Login using your Login ID to take Quiz</H2>";
